...
/*
 * 클래스 내부에 요소로 추상메서드를 하나라도 선언하는 순간
 * 클래스 또한 abstract 키워드를 붙여서 추상 클래스로 정의해야함!
 * 추상클래스 == 필드 + 메서드 + 추상메서드(생략가능)
 * 
 * -> ★추상메서드가 존재하지 않아도 추상클래스로 정의가능
 * 
 ...
 * 	  생각이 들면 추상클래스로 선언
 * 
 * => 객체 생성은 불가능하게 하고 공통적인 속성 및 메서드 그리고 타입만 다형성을 적용하게 하고싶다.
 */
public abstract class Sports {
	...
	// 자식들이 오버라이딩해서 다형성을 적용시켜 사용할 용도의 메서드
	//public void rule() { System.out.println("규칙입니다."); }
