...
public class StringController {
	...
	public void method1() {
		...
		// 실제 담겨있는 문자열 리터럴 value값을 반환하도록 오버라이딩
		...
		// 2.주소값 비교는 물론이고 문자열 값도 비교하도록 오버라이딩
		...
		// 주소값을 해싱하는 것이 아니라 실제 담긴 문자열값을 기반으로 해서 해시코드 값을 만들도록 오버라이딩

		// 진짜 참조형 변수들을 식별할 수 있는 값을 알아내는 법
	...
	public void method3() {
		...
		// 특징: 동일한 내용의 문자열 리터럴이 존재할 수 없음 > 같은 문자열은 같은 주소를 참조
	...
	public void method4() {
		...
		// 충돌환경이 아니라면 굳이 구현할 필요가 없음 > StringBuilder
	}

	// 문자열과 관련된 메서드들
	public void stringMethod() {

		String str1 = "경실련 아카데미";
		...
		// => 문자열의 beginindex위치에서 문자열 끝까지의 문자열을 추출해서 변환
		System.out.println(phoneNumber.substring(4));
		System.out.println(phoneNumber.substring(4, 8));

		// 4. 문자열.indexOf(str) : int
		System.out.println(str1.indexOf("카"));

		String[] emails = { "hong@kh.com", "kim@kh.com", "hitel@kh.com", "hoho@kh.com" };
		...
		String str3 = "				Java 			"; // 공백문자가 붙어서 오는경우
		// 7. 문자열.trim(): String
		System.out.println(str3);
		System.out.println(str3.trim());
		
		// 8.문자열.toUpperCase(): String => 싹 다 대문자로 바꾸기
		// 		  toLowCase() : String => 싹 다 소문자로 바꾸기
		
		Scanner sc = new Scanner(System.in);
		System.out.println("정말 하시곘어요");
		String answer = sc.nextLine().toUpperCase();
		String upperAswer1 = answer;//.toUpperCase();
		String upperAswer2 = answer.toUpperCase();
				
		// method 체이닝
		if(answer.equals("Y") || answer.equals("y")) {
			System.out.println("참을 수 없다.");
		}
	}
