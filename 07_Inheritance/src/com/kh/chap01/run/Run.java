...
public class Run {
	...
	public static void main(String[] args) {
		...
		KoreaFood kr = new KoreaFood("비빔밥", "밥", 5, 2);
		// foodName, material, cookingTime, oil
		ItalyFood it= new ItalyFood("파스타", "면", 15, 5);
		// foodName, material, cookingTime, fresh
		JapanFood jp = new JapanFood("스시", "밥", 10, 10);
		
		System.out.println(kr.information());
		System.out.println(it.information());
		System.out.println(jp.information());
		
		/*
		 * 매 크래스마다 중복된 코드들을 하나하나 기술하다보면
		 * 코드의 추가 또는 수정과 같은 유지보수 시 전부 한땀한땀 찾아서 고쳐야하는 번거로움이 생김
		 * 
		 * 상속이라는 개념을 적용해서
		 * 매 클래스마다 중복된 필드, 메서도들을
