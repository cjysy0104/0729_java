...
public class C_Switch {
	...
	public void method0() {
		...
		System.out.println("몇층? (B1 / B2 / B3)");
	 ...
	 * case 값2 : 실행할 코드b; // 동등비교대상 == 값2 true일 경우 실행할 코드 b를 수행
	 * break;
	 * case 값n : 실행할 코드n; // 동등비교대상 == 값n true일 경우 실행할 코드 n를 수행
	 * break;
	 * default : 실행할 코드 // == else
	 * }
	 */
	...
	public void method1() {
		...
		// 각 음식마다 가격을 출력해줄 것
		// 부대찌개(11000), 떡갈비(13000), 제육볶음(7000), 칼국수(8000), 수제비(7000)
		Scanner sc = new Scanner(System.in);
...
//		switch(menu) {
//		
//		case "부대찌개" : System.out.println("11000원"); break;
//		
//		case "떡갈비" : System.out.println("13000원");break;
//		
//		case "칼국수" : System.out.println("8000원");break;
//		
//		case "제육볶음" : System.out.println("7000원");break;
//		
//		case "수제비" : System.out.println("7000원");break;
//		
...
//		}
		...
		default : System.out.println("그런 메뉴는 없다. (╬▔皿▔)╯");
		return; // 현재 실행되고 있는 메서드 영역을 아예 빠져나간다.
				// 메서드를 호출한 곳으로 돌아감
		}//break를 만나면 빠져나오는 부분
		
		//if(price != 0) System.out.println(price + "원 입니다. (●'◡'●)");
	...
	public void login() {
		...
		// 만약에 사용자가 로그인 시 입력한 아이디값과 회원가입 시 가입한 아이디 값이 동일하고
