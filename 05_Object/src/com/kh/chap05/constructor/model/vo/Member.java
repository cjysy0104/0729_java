...
public class Member {
	...
	// [ 생성자부 ]
	/*
	 * 생성자(Constructor) : 객체를 생성하는데 사용하는 특수한 유형의 메서드
	 * 
	 * [ 표현법 ]
	...
	public Member() {
		// 기본생성자(매개변수가 없음)
		//System.out.println("쨔쟌"); >> 객체 생성 시 실행됨
	...
	*/
	...
	// !!대소문자 구별하여 class명과 동일하게(안하면 메서드취급)
	// public member() <-- 메서드라고 인식
	// public void Member() <-- 메서드라고 인식
	public Member() {} // <-- 기본생성자 꼭 만들 것!
...
//		System.out.println("전달받은 비밀번호 값: " + userPwd);
	...
	/*
	 * 1. 반드시 생성자의 이름을 클래스의 이름과 동일하게 작성해야함(대소문자 주의)
	 * 2. 반환형이 존재해서는 안됨!(메서드로 판단함)
	 ...
	 * 4) 기본생성자 및 모든 필드를 매개변수로 가지고 있는 생성자 형성
	 * 5) 직접접근으로 사용하고 있던 실행클래스의 코드들을 전부 getter / setter 대체
	 * 
	 * 
	 */
