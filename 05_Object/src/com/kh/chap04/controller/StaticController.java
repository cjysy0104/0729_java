...
public class StaticController {
	...
	public static String str = "static field"; // static 글꼴: 기울임꼴 
    //			  String str2;
	...
	// static == "공유"의 개념이 강함
	// 프로그램 실행과 동시에 올려놓고 거기서 값을 공유해서 사용할 목적 (일반적으로 private 사용 x, 보통 상수필드로 사용)
	 ...
	 * => 한 번 지정한 값을 고정해서 쓰겠다. 무조건 초기화 해야함.
	 * 
	 * static: 공유의 목적
	 * final : 한 번 초기화하고 절대 바꾸지 않는다.
	 * 
