...
public class Run {
	...
	public static void main(String[] args) {
		...
		// add(추가할요소)
		set.add("Hello, World!");
		set.add("Nice to meet you");
		set.add("Have a nice day");
		set.add(new String("Nice to meet you"));
		set.add(new String("Hello, World!"));
		set.add("Trolling Set");
		...
		mbti.add(estj);
		mbti.add(estp);
		mbti.add(new MBTI("E", "S", "T", "P")); // estp가 중복되서 출력됨
		...
		*/
		...
		// List, Set 전부 다 iterator 구현중
		//
		// 모든 실제 객체를 Iterator타입으로 사용할 수 있음(다형성 적용)
		
		// => List계열 Set계열은 전부 iterator()를 호출해서 반복을 시킬 수 있음
		// => Map계열에서는 바로는 불가능
